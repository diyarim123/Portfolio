  ...
  return (
    <div className='p-6 text-white w-full sticky z-20 top-0 backdrop-blur-sm'>
      ...
      <div className='flex justify-between'>
        ...
        > 
          <a className='px-5 py-3 border-2 border-emerald-500 text-emerald-500 hover:text-black font-semibold hover:bg-emerald-500 rounded-md' href='/CV.pdf' >My Resume</a>
        </motion.div>
      </div>
